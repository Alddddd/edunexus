...
<div class="w-full min-w-0 max-w-7xl space-y-5 text-ui-anchor">
    ...
    <section class="rounded-2xl border border-ui-action/15 bg-gradient-to-br from-ui-action/10 via-ui-surface/90 to-ui-proof/10 p-6 shadow-[0_20px_44px_rgba(11,93,86,0.10)] ring-1 ring-ui-anchor/5">
            ...
            <tbody class="divide-y divide-ui-border/70 bg-ui-surface">
                @forelse($recentTransactions as $transaction)
                    <tr class="transition hover:bg-ui-canvas/70">
                        ...
                        <td class="max-w-[16rem] break-all px-5 py-4 font-mono text-xs text-ui-subtext xl:max-w-[18rem]">
